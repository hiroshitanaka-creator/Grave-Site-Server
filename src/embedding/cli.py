...
def build_parser() -> argparse.ArgumentParser:
    ...
    index_parser.add_argument("--dimensions", type=_positive_int, default=256)
    ...
    search_parser.add_argument("--top-k", type=_positive_int, default=5)
    search_parser.add_argument("--dimensions", type=_positive_int, default=256)
